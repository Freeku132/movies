...
{{--                        @foreach(array_splice($movie['credits']['crew'], 0, 3) as $crew)--}}
                ...
                <div class="mt-12">
                    ...
                    <button
                        @click="isOpen = true"
                        href="https://youtube.com/watch?v={{$movie['videos']['results'][0]['key']}}" class="flex inline-flex items-center bg-orange-500 text-gray-800 rounded font-semibold px-5 py-4 hover:bg-orange-600
